...
print_status "Killing all existing processes on ports 8080, 3000-3010, 5173..."
lsof -ti:8080,3000,3001,3002,3003,3004,3005,3006,3007,3008,3009,3010,5173 | xargs kill -9 2>/dev/null || print_warning "No processes found to kill"

# Wait a moment for processes to fully terminate
sleep 3

# Step 2: Navigate to project root and create logs directory
cd "$PROJECT_ROOT"
mkdir -p logs
